...
// default settings
#define DEFAULT_AXIS_STEPS_PER_UNIT   {2548.7964, 2552.7231, 2560,152}    // tiges filetées M8



#define DEFAULT_MAX_FEEDRATE          {6, 5, 7, 60}    // (mm/sec)    45
#define DEFAULT_MAX_ACCELERATION      {30,30,30,12000}    // 10000 X, Y, Z, E maximum start speed for accelerated moves. E default values are good for skeinforge 40+, for older versions raise them a lot.
